...
# the arid Egyptian desert palette of the campaign's City of Exiles.
STYLE_SUFFIX = (
    " — cinematic fantasy illustration, arid Egyptian desert palette, warm gold "
    "and sandstone, dramatic rim light, painterly, no text or lettering."
)
